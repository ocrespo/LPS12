...
public class Entity extends Card{
	...
	public Entity(String code, String name,Element element ,int attack,int defense,ArrayList<CombatAction> actionAttack,ArrayList<CombatAction> actionDefense,CombatAction actionFinally,
			ActiveAction actionActive,ArrayList<PassiveAction> actionPassive,
