...
public class IndexCards implements Serializable,Cloneable {
	/**
	 * 
	 */
	...
	public Object clone(){
        ...
        try{
            obj=super.clone();
            HashMap<String, LinkedCard> aux = new HashMap<String, LinkedCard>();
            for(LinkedCard lin : index.values()){
            	aux.put(lin.getCard().getCode(), (LinkedCard) lin.clone());
            }
            ((IndexCards)obj).index = aux;
