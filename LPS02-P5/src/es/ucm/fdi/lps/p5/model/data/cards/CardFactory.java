...
import es.ucm.fdi.lps.p5.DAO.DTOCard;
import es.ucm.fdi.lps.p5.model.data.Cost;
import es.ucm.fdi.lps.p5.model.data.actions.active.AddMana;
import es.ucm.fdi.lps.p5.model.data.actions.active.AttackerAllStatsModifiers;
import es.ucm.fdi.lps.p5.model.data.actions.active.ChangeAllEntityElements;
import es.ucm.fdi.lps.p5.model.data.actions.active.ChangeEntity;
import es.ucm.fdi.lps.p5.model.data.actions.active.Copy;
import es.ucm.fdi.lps.p5.model.data.actions.active.Counter;
import es.ucm.fdi.lps.p5.model.data.actions.active.DamageAttackStat;
import es.ucm.fdi.lps.p5.model.data.actions.active.DamageManaAllEntity;
import es.ucm.fdi.lps.p5.model.data.actions.active.DamageWarlock;
import es.ucm.fdi.lps.p5.model.data.actions.active.DefenderAllStatsModifiers;
import es.ucm.fdi.lps.p5.model.data.actions.active.EnviromentExchange;
import es.ucm.fdi.lps.p5.model.data.actions.active.FinishGame;
import es.ucm.fdi.lps.p5.model.data.actions.active.Kill;
import es.ucm.fdi.lps.p5.model.data.actions.active.MultiplyStatsModifiers;
import es.ucm.fdi.lps.p5.model.data.actions.active.RotateAllEntities;
import es.ucm.fdi.lps.p5.model.data.actions.active.SeeHand;
import es.ucm.fdi.lps.p5.model.data.actions.active.StealHand;
import es.ucm.fdi.lps.p5.model.data.actions.active.TransformsAllMana;
import es.ucm.fdi.lps.p5.model.data.actions.active.Turn;
import es.ucm.fdi.lps.p5.model.data.actions.active.UnStopActive;
import es.ucm.fdi.lps.p5.model.data.actions.combat.AttackStatsModifier;
import es.ucm.fdi.lps.p5.model.data.actions.combat.DamageWarlockDefenderDie;
import es.ucm.fdi.lps.p5.model.data.actions.combat.DefenseStatsModifier;
import es.ucm.fdi.lps.p5.model.data.actions.combat.OverOneStatsModifier;
import es.ucm.fdi.lps.p5.model.data.actions.combat.TurnAllDefender;
import es.ucm.fdi.lps.p5.model.data.actions.combat.UpCard;
import es.ucm.fdi.lps.p5.model.data.actions.mixed.DrawMaxHand;
import es.ucm.fdi.lps.p5.model.data.actions.mixed.OnlyDefenseMe;
import es.ucm.fdi.lps.p5.model.data.actions.passive.CantTargetIntervention;
import es.ucm.fdi.lps.p5.model.data.actions.passive.MultiplyDamage;
import es.ucm.fdi.lps.p5.model.data.actions.passive.NoInitialized;
import es.ucm.fdi.lps.p5.model.data.actions.passive.StatsModifiersCardInGame;
...
public class CardFactory {
	...
	public static Card getCard(DTOCard dto){
		String type = dto.getType();
		if(type.equals("entity")){
			return new Entity(dto.getCode(), dto.getName(), dto.getElement(), dto.getAttack(), dto.getDefense(),
			...
			return new Enviroment(dto.getCode(), dto.getName(), dto.getElement(), dto.getActionActive(), dto.getMax(), dto.getDescription(), dto.getDirImg());		
		}
		else if(type.equals("intervention")){
			return new Intervention(dto.getCode(), dto.getName(), dto.getElement(), dto.getActionActive(), dto.getCost(), dto.getMax(), dto.getDescription(), dto.getDirImg());
		}
		return null;
	}
