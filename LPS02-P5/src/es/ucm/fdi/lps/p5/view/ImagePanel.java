...
public class ImagePanel extends JPanel{
	...
	private static final String dirWrongIcon = "imagenes\\Iconos\\Bloqueo brujo.png";
    ...
    public ImagePanel(int width ,int height,String file,boolean combat,boolean check,boolean disable) {
    	...
    	try { 
    		...
    		if(combat){
	    		...
	    		this.combat = aux.getScaledInstance(20, 20,Image.SCALE_AREA_AVERAGING);*/
    		...
    		if(check){
	    		...
	    		this.check = aux.getScaledInstance(20, 20,Image.SCALE_AREA_AVERAGING);*/
    		...
    		if(disable){
	    		...
	    		this.wrong = aux.getScaledInstance(40,40,Image.SCALE_AREA_AVERAGING);*/
