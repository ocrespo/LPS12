...
public abstract class Card implements Comparable<Card> , Serializable , Cloneable{
	...
	public Object clone(){
        ...
        try{
            obj=super.clone();
            if(this.getActionAttack() != null){
            	((Card)obj).setActionAttack((ArrayList<CombatAction>) this.getActionAttack().clone());
            }
            if(this.getActionDefense() != null){
            	((Card)obj).setActionDefense((ArrayList<CombatAction>) this.getActionDefense().clone());
            }
            if(this.getActionPassive() != null){
            	((Card)obj).setActionPassive((ArrayList<PassiveAction>) this.getActionPassive().clone());
            }
            if(this.getActionActive() != null){
            	((Card)obj).setActionActive((ActiveAction) this.getActionActive().clone());
