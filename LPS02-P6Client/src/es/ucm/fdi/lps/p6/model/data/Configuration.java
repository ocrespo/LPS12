...
public class Configuration {
			...
			if((!line.equals("")) && (!line.startsWith("#")) && (!line.equals("@admin"))){
				if (!title){
					if(line.startsWith("BRUJOS&TRIFULCAS")){
						if (!line.endsWith("5") &&!line.endsWith("5") && !line.endsWith("4") && !line.endsWith("3") && !line.endsWith("2") && !line.endsWith("1")){
	...
	public String readAllFile(String dir) throws FileError{
		String aux = "";
		String line = "";
		try {
			File file = new File (dir);
			...
			throw new FileError("Hubo un problema con la aprtura del fichero de brujo "+dir+" o el fichero no existe" );
